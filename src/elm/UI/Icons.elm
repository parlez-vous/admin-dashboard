...
rightCaret =
    svg
        [ class "fill-current text-teal-500 h-6 inline-block"
        , viewBox "0 0 20 20"
        ]
        [ Svg.path [ d "M11.611 10.049l-4.76-4.873a.783.783 0 011.117-1.093l5.306 5.433a.78.78 0 01-.012 1.105L7.83 15.928a.784.784 0 01-1.106-.013.78.78 0 01.012-1.104l4.875-4.762z" ] [] ]
...
x =
    svg
        ...
        [ Svg.path [ d "M15.898 4.045a.698.698 0 00-.986 0l-4.71 4.711-4.709-4.711a.698.698 0 00-.986.986l4.709 4.711-4.71 4.711a.698.698 0 00.985.986l4.711-4.711 4.71 4.711a.695.695 0 00.494.203.694.694 0 00.492-1.189l-4.711-4.711 4.711-4.711a.694.694 0 000-.986z" ] [] ]
...
cog =
    svg
        [ class "fill-current h-8 inline-block"
        , viewBox "0 0 24 24"
        ]
        [ Svg.path
            [ fill "#fa544b"
